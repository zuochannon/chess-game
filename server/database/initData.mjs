...
const initGameHistory = async () => {
  ...
  INSERT INTO GameHistory (gameID, players, playerNames, winnerID, loserID, result, timestamp, turns, moves, game_type, comments)
  VALUES (
  ...
  INSERT INTO GameHistory (gameID, players, playerNames, result, timestamp, turns, moves, game_type, comments)
  VALUES (
      ...
      '2024-05-12 14:20:00', 
      30, 
      ['e4', 'e5', 'Nf3', 'Nc6', 'Bc4', 'Bc5', 'd3', 'd6', 'c3', 'Nf6'], 
      'rapid',
  ...
  VALUES (
      ...
      '2024-05-13 11:00:00', 
      15, 
      ['e4', 'e5', 'Nf3', 'Nc6', 'Bc4', 'Bc5', 'O-O', 'd6', 'Nc3', 'Bg4'], 
      'standard',
  ...
  VALUES (
      ...
      '2024-05-16 09:45:00', 
      21, 
      ['d4', 'Nf6', 'c4', 'e6', 'Nc3', 'Nf6', 'Bg5', 'Be7', 'e3', 'O-O'], 
      'blitz',
